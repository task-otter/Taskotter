...
A [TaskOtter](https://github.com/task-otter/Taskotter) module for [actionlint](https://github.com/rhysd/actionlint) — a static checker for GitHub Actions workflow files.
