...
A [TaskOtter](https://github.com/task-otter/Taskotter) module for [zizmor](https://github.com/woodruffw/zizmor) — a security auditor for GitHub Actions workflow files.
